...
import ch3_simulation_test_epy_block_0 as epy_block_0  # embedded python block
import ch3_simulation_test_epy_block_0_0 as epy_block_0_0  # embedded python block
import time
import threading
...
class ch3_simulation_test(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS third channel", catch_exceptions=True)
...
def main(top_block_cls=ch3_simulation_test, options=None):
    tb = top_block_cls()
