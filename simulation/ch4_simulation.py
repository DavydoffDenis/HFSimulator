...
import ch4_simulation_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import ch4_simulation_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block
import time
import threading
...
class ch4_simulation(gr.top_block):
...
def main(top_block_cls=ch4_simulation, options=None):
    tb = top_block_cls()
