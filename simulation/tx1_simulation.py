...
import time
import threading
import tx1_simulation_epy_block_0 as epy_block_0  # embedded python block
import tx1_simulation_epy_block_0_0 as epy_block_0_0  # embedded python block




class tx1_simulation(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS tx1 channel", catch_exceptions=True)
...
def main(top_block_cls=tx1_simulation, options=None):
    tb = top_block_cls()
