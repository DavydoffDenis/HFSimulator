...
import simulation_test_grc_new_version_epy_block_0 as epy_block_0  # embedded python block
import simulation_test_grc_new_version_epy_block_0_0 as epy_block_0_0  # embedded python block
import simulation_test_grc_new_version_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import simulation_test_grc_new_version_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block
import time
import threading
...
class simulation_test_grc_new_version(gr.top_block):
...
def main(top_block_cls=simulation_test_grc_new_version, options=None):
    tb = top_block_cls()
