...
import ch1_simulation_test_epy_block_0 as epy_block_0  # embedded python block
import ch1_simulation_test_epy_block_0_0 as epy_block_0_0  # embedded python block
import time
import threading
...
class ch1_simulation_test(gr.top_block):
...
def main(top_block_cls=ch1_simulation_test, options=None):
    tb = top_block_cls()
