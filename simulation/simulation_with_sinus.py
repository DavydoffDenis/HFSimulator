...
class simulation(gr.top_block):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 0.3, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_3, 0), (self.blocks_multiply_const_vxx_3, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.blocks_multiply_const_vxx_3_0, 0))
