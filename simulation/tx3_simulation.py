...
import time
import threading
import tx3_simulation_epy_block_0 as epy_block_0  # embedded python block
import tx3_simulation_epy_block_0_0 as epy_block_0_0  # embedded python block




class tx3_simulation(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS tx3 channel", catch_exceptions=True)
        ...
        self.connect((self.audio_source_0_0_0, 0), (self.blocks_float_to_complex_0, 0))
...
def main(top_block_cls=tx3_simulation, options=None):
    tb = top_block_cls()
