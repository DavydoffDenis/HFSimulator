...
class ch2_simulation(gr.top_block):
    ...
    def __init__(self):
        ...
        self.connect((self.audio_source_0, 3), (self.blocks_null_sink_0, 2))
        self.connect((self.audio_source_0, 2), (self.blocks_null_sink_0, 1))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0_0_0, 0), (self.blocks_add_xx_0_0_0_0, 1))
        self.connect((self.blocks_multiply_xx_0_0_0_0_0, 0), (self.blocks_add_xx_0_0_1, 1))
        ...
        self.connect((self.blocks_null_source_0, 2), (self.audio_sink_0, 3))
        self.connect((self.blocks_null_source_0, 1), (self.audio_sink_0, 2))
