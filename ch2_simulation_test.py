...
class ch2_simulation_test(gr.top_block):
    ...
    def __init__(self):
        ...
        self.analog_fastnoise_source_x_2 = analog.fastnoise_source_c(analog.GR_GAUSSIAN, 1, 11, 8192)
        self.analog_fastnoise_source_x_1 = analog.fastnoise_source_c(analog.GR_GAUSSIAN, 1, 10, 8192)
