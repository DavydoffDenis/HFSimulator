...
import ch2_simulation_test_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import ch2_simulation_test_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block
import time
import threading
...
class ch2_simulation_test(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS second channel", catch_exceptions=True)
        ...
        self.audio_source_0_0_0_0 = audio.source(samp_rate, '', True)
        self.audio_source_0_0_0 = audio.source(samp_rate, '', True)
        self.audio_source_0_0 = audio.source(samp_rate, '', True)
        self.audio_source_0 = audio.source(samp_rate, '', True)
        self.audio_sink_0_0_2 = audio.sink(samp_rate, '', False)
        self.audio_sink_0_0_1 = audio.sink(samp_rate, '', False)
        self.audio_sink_0_0_0 = audio.sink(samp_rate, '', False)
        self.audio_sink_0_0 = audio.sink(samp_rate, '', False)
...
def main(top_block_cls=ch2_simulation_test, options=None):
    tb = top_block_cls()
