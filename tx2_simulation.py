...
import time
import threading
import tx2_simulation_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import tx2_simulation_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block




class tx2_simulation(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS tx2 channel", catch_exceptions=True)
...
def main(top_block_cls=tx2_simulation, options=None):
    tb = top_block_cls()
