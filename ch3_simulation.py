...
import ch3_simulation_epy_block_0 as epy_block_0  # embedded python block
import ch3_simulation_epy_block_0_0 as epy_block_0_0  # embedded python block
import time
import threading
...
class ch3_simulation(gr.top_block):
...
def main(top_block_cls=ch3_simulation, options=None):
    tb = top_block_cls()
