...
import time
import threading
import tx4_simulation_epy_block_0_0_0 as epy_block_0_0_0  # embedded python block
import tx4_simulation_epy_block_0_0_0_0 as epy_block_0_0_0_0  # embedded python block




class tx4_simulation(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "HFS tx4 channel", catch_exceptions=True)
        ...
        self.rx4_en = rx4_en = 0
        self.rx3_en = rx3_en = 0
        self.rx2_en = rx2_en = 0
        self.rx1_en = rx1_en = 0
        ...
        self.blocks_multiply_const_vxx_4_2 = blocks.multiply_const_ff(rx4_en)
        self.blocks_multiply_const_vxx_4_1 = blocks.multiply_const_ff(rx3_en)
        self.blocks_multiply_const_vxx_4_0 = blocks.multiply_const_ff(rx2_en)
        self.blocks_multiply_const_vxx_4 = blocks.multiply_const_ff(rx1_en)
        ...
        self.connect((self.audio_source_0_0_0_0, 0), (self.blocks_float_to_complex_0_0, 0))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_const_vxx_4, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_const_vxx_4_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_const_vxx_4_1, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_multiply_const_vxx_4_2, 0))
        ...
        self.connect((self.blocks_multiply_const_vxx_4, 0), (self.audio_sink_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_4_0, 0), (self.audio_sink_0_0_0, 0))
        self.connect((self.blocks_multiply_const_vxx_4_1, 0), (self.audio_sink_0_0_1, 0))
        self.connect((self.blocks_multiply_const_vxx_4_2, 0), (self.audio_sink_0_0_2, 0))
    ...
    def set_tau(self, tau):
        self.tau = tau
        self.blocks_delay_0_0.set_dly(int(self.tau*self.samp_rate))
    ...
    def set_rx4_en(self, rx4_en):
        self.rx4_en = rx4_en
        self.blocks_multiply_const_vxx_4_2.set_k(self.rx4_en)

    def get_rx3_en(self):
        return self.rx3_en

    def set_rx3_en(self, rx3_en):
        self.rx3_en = rx3_en
        self.blocks_multiply_const_vxx_4_1.set_k(self.rx3_en)

    def get_rx2_en(self):
        return self.rx2_en

    def set_rx2_en(self, rx2_en):
        self.rx2_en = rx2_en
        self.blocks_multiply_const_vxx_4_0.set_k(self.rx2_en)

    def get_rx1_en(self):
        return self.rx1_en

    def set_rx1_en(self, rx1_en):
        self.rx1_en = rx1_en
        self.blocks_multiply_const_vxx_4.set_k(self.rx1_en)
    ...
    def set_noSpread(self, noSpread):
        ...
        self.blocks_selector_0_0_0.set_input_index(self.noSpread)
        self.blocks_selector_0_1.set_input_index(self.noSpread)
    ...
    def set_kN(self, kN):
        self.kN = kN
        self.analog_noise_source_x_1_0.set_amplitude(1e-0*self.kN)
    ...
    def set_freqShift(self, freqShift):
        ...
        self.analog_sig_source_x_1_0.set_frequency(self.freqShift)
    ...
    def set_ampl(self, ampl):
        self.ampl = ampl
        self.analog_const_source_x_1_0_0.set_offset(self.ampl[1][1])
...
def main(top_block_cls=tx4_simulation, options=None):
    tb = top_block_cls()
